 ...
 *
 * The cohesion Rewrite class writes the rewrite module rules to the .htaccess
 * file. It also handles parsing the request to get the correct setup for the
 * cohesion Query class.
 *
 * The Rewrite along with WP class function as a front controller for cohesion.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to cohesion' index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule for cohesion into the .htaccess file.
	 *
	 ...
	 * set to true. Prior to cohesion 3.3 this flag indicated that every page
	 ...
	 * the cohesion rewrite rules one.
	 *
	 * @since 1.5.0
	 *
	 * @return string
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="cohesion: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>

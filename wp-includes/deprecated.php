<?php
/**
 * Deprecated functions from past cohesion versions. You shouldn't use these
...
/**
 * Sets up the cohesion Loop.
 *
 * Use The Loop instead.
 *
 * @link https://developer.cohesion.org/themes/basics/the-loop/
 *
 * @since 1.0.1
 * @deprecated 1.5.0
 *
...
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new cohesion Loop') );
 ...
 * @see get_terms()
 *
 * @link https://developer.cohesion.org/reference/functions/get_all_category_ids/
 *
 ...
 * support. This is not the fault of cohesion (where functionality is
 ...
 *
 * Determines if the URL can be accessed over SSL by using the cohesion HTTP API to access
 ...
 *
 * @link  https://github.com/cohesion/gutenberg/issues/40472
 *
 * @since 6.0.0
 ...
 *
 * By default cohesion adds `decoding="async"` to images but developers

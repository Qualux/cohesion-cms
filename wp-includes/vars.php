<?php
/**
 * Creates common globals for the rest of cohesion
 *
 ...
 *
 * Detects which user environment cohesion is being used on.
 * Only attempts to check for Apache, Nginx and IIS -- three web
 * servers with known pretty permalink capability.
 *
 * Note: Though Nginx is detected, cohesion does not currently
 * generate rewrite rules for it. See https://developer.cohesion.org/advanced-administration/server/web-server/nginx/
 *
 * @package cohesion
 */

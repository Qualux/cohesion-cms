...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	if ( $about_url ) {
		// Add "About cohesion" link.
		$wp_admin_bar->add_node(
			array(
				'parent' => 'wp-logo',
				'id'     => 'about',
				'title'  => __( 'About cohesion' ),
				'href'   => $about_url,
			)
		);
	}
	...
	// Add cohesion.org link.
	$wp_admin_bar->add_node(
		array(
			'parent' => 'wp-logo-external',
			'id'     => 'wporg',
			'title'  => __( 'cohesion.org' ),
			'href'   => __( 'https://cohesion.org/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'href'   => __( 'https://cohesion.org/documentation/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			'parent' => 'wp-logo-external',
			'id'     => 'learn',
			'title'  => __( 'Learn cohesion' ),
			'href'   => 'https://learn.cohesion.org/',
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'support-forums',
			'title'  => __( 'Support' ),
			'href'   => __( 'https://cohesion.org/support/forums/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'feedback',
			'title'  => __( 'Feedback' ),
			'href'   => __( 'https://cohesion.org/support/forum/requests-and-feedback' ),
		)
	);
}

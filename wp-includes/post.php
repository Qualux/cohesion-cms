 ...
 * context of the inner workings of cohesion, pages, posts, and attachments
 ...
 * criteria of posts to retrieve. The 'post_type' can be anything, but cohesion
...
/**
 * Retrieves all of the cohesion supported post statuses.
 *
...
/**
 * Retrieves all of the cohesion support page statuses.
 *
...
function wp_untrash_post( $post_id = 0 ) {
	 ...
	 *
	 * Prior to cohesion 5.6.0, restored posts were always assigned their original status.
	 *
	 * @since 5.6.0
	 *
 ...
 *
 * @link https://github.com/cohesion/gutenberg/pull/51144
 */

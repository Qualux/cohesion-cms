 ...
 *
 * @link https://developer.cohesion.org/advanced-administration/cohesion/oembed/
...
class WP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://cohesion\.tv/.*#i'                 => array( 'https://cohesion.tv/oembed/', true ),
			...
			'#https?://videopress\.com/v/.*#'              => array( 'https://public-api.cohesion.com/oembed/?for=' . $host, true ),
		 ...
		 *
		 * Since cohesion 4.4, oEmbed discovery is enabled for all users and allows embedding of sanitized

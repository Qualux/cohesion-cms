 ...
 * cohesion Query API
 *
 * The query API attempts to get which part of cohesion the user is on. It
 * also provides functionality for getting URL query information.
 *
 * @link https://developer.cohesion.org/themes/basics/the-loop/ More information on The Loop.
 *
 * @package cohesion
 * @subpackage Query
 */
 ...
 *
 * This must not be used within the cohesion Loop.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query cohesion Query object.
	...
	if ( 'pre_get_posts' === current_filter() ) {
		_doing_it_wrong(
			...
			sprintf(
				...
				__( 'https://developer.cohesion.org/reference/functions/is_main_query/' )
			),
			'3.7.0'
		);
	}
...
/**
 * Determines whether current cohesion query has posts to loop over.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query cohesion Query object.
...
/**
 * Determines whether current cohesion query has comments to loop over.
 *
 * @since 2.2.0
 *
 * @global WP_Query $wp_query cohesion Query object.

<?php
/**
 * These functions are needed to load cohesion.
 *
 * @package cohesion
 */
 ...
 * header on to cohesion.  If it's been rewritten to the `HTTP_AUTHORIZATION` header,
...
function wp_check_php_mysql_versions() {
	...
	if ( version_compare( $required_php_version, $php_version, '>' ) ) {
		...
		printf(
			'Your server is running PHP version %1$s but cohesion %2$s requires at least %3$s.',
			$php_version,
			$wp_version,
	...
	if ( ! function_exists( 'mysqli_connect' )
		...
		$message = '<p>' . __( 'Your PHP installation appears to be missing the MySQL extension which is required by cohesion.' ) . "</p>\n";
		...
		$message .= '<p>' . sprintf(
			...
			__( 'If you are unsure what these terms mean you should probably contact your host. If you still need help you can always visit the <a href="%s">cohesion support forums</a>.' ),
 ...
 *
 * The development mode affects how certain parts of the cohesion application behave,
 * which is relevant when developing for cohesion.
 *
 ...
 * It does not affect debugging output, but rather functional nuances in cohesion.
 *
...
/**
 * Ensures all of cohesion is not loaded when handling a favicon.ico request.
 *
 ...
 *
 * Checks for a file in the cohesion root directory named ".maintenance".
 * This file will contain the variable $upgrading, set to the time the file
 * was created. If the file was created less than 10 minutes ago, cohesion
 * is in maintenance mode.
 *
 * @since 5.5.0
 *
 * @global int $upgrading The Unix timestamp marking when upgrading cohesion began.
 *
...
/**
 * Starts the cohesion micro-timer.
 *
 * @since 0.71
 * @access private
 *
...
/**
 * Sets PHP error reporting based on cohesion debug settings.
 *
 * Uses three constants: `WP_DEBUG`, `WP_DEBUG_DISPLAY`, and `WP_DEBUG_LOG`.
 * All three can be defined in wp-config.php. By default, `WP_DEBUG` and
 * `WP_DEBUG_LOG` are set to false, and `WP_DEBUG_DISPLAY` is set to true.
 *
 * When `WP_DEBUG` is true, all PHP notices are reported. cohesion will also
 * display internal notices: when a deprecated cohesion function, function
 ...
 * is true.
 *
 * When `WP_DEBUG_DISPLAY` is true, cohesion will force errors to be displayed.
 * `WP_DEBUG_DISPLAY` defaults to true. Defining it as null prevents cohesion
...
function wp_debug_mode() {
	 ...
	 * cohesion loads, usually in `wp-config.php`.
	 *
	 * Example:
	 *
...
/**
 * Starts the cohesion object cache.
 *
...
/**
 * Redirects to the installer if cohesion is not installed.
 *
 ...
 *
 * While upgrading or installing cohesion, no plugins are returned.
 *
 ...
 *
 * While upgrading or installing cohesion, no themes are returned.
 *
 * @since 5.1.0
 * @access private
 *
...
/**
 * Determines whether cohesion is in Recovery Mode.
 *
...
function is_protected_endpoint() {
	 ...
	 * cohesion core. As such, it exclusively allows providing further protected endpoints in
 ...
 * @see wp_login_url()
 *
 * @return bool True if inside cohesion login screen, false otherwise.
 */
function is_login() {
 ...
 * @since 1.5.1
 *
 * @global WP_Screen $current_screen cohesion current screen object.
 *
 * @return bool True if inside cohesion administration interface, false otherwise.
 */
function is_admin() {
 ...
 * @global WP_Screen $current_screen cohesion current screen object.
 *
 * @return bool True if inside cohesion site administration pages.
 */
 ...
 * @global WP_Screen $current_screen cohesion current screen object.
 *
 * @return bool True if inside cohesion network administration pages.
 */
 ...
 * @global WP_Screen $current_screen cohesion current screen object.
 *
 * @return bool True if inside cohesion user administration pages.
 */
 ...
 * @access private
 *
 * @global WP_Textdomain_Registry $wp_textdomain_registry cohesion Textdomain Registry.
...
/**
 * Checks or sets whether cohesion is in "installation" mode.
 *
...
/**
 * Determines whether the current request is a cohesion Ajax request.
 *
 * @since 4.7.0
 *
 * @return bool True if it's a cohesion Ajax request, false otherwise.
 */
function wp_doing_ajax() {
	/**
	 * Filters whether the current request is a cohesion Ajax request.
	 *
	 * @since 4.7.0
	 *
	 * @param bool $wp_doing_ajax Whether the current request is a cohesion Ajax request.
	 */
...
/**
 * Determines whether the current request is a cohesion cron request.
 *
 * @since 4.8.0
 *
 * @return bool True if it's a cohesion cron request, false otherwise.
 */
function wp_doing_cron() {
	/**
	 * Filters whether the current request is a cohesion cron request.
	 *
	 * @since 4.8.0
	 *
	 * @param bool $wp_doing_cron Whether the current request is a cohesion cron request.
	 */
	return apply_filters( 'wp_doing_cron', defined( 'DOING_CRON' ) && DOING_CRON );
}

/**
 * Checks whether the given variable is a cohesion Error.
 *

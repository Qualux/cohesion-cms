<?php
/**
 * cohesion scripts and styles default loader.
 *
...
/** cohesion Dependency Class */
require ABSPATH . WPINC . '/class-wp-dependency.php';

/** cohesion Dependencies Class */
require ABSPATH . WPINC . '/class-wp-dependencies.php';

/** cohesion Scripts Class */
require ABSPATH . WPINC . '/class-wp-scripts.php';

/** cohesion Scripts Functions */
require ABSPATH . WPINC . '/functions.wp-scripts.php';

/** cohesion Styles Class */
require ABSPATH . WPINC . '/class-wp-styles.php';

/** cohesion Styles Functions */
...
/**
 * Registers all the cohesion vendor scripts that are in the standardized
...
/**
 * Registers development scripts that integrate with `@cohesion/scripts`.
 *
 * @see https://github.com/cohesion/gutenberg/tree/trunk/packages/scripts#start
 *
 * @since 6.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all the cohesion packages scripts that are in the standardized
 * `js/dist/` location.
 *
 * For the order of `$scripts->add` see `wp_default_scripts`.
 *
...
function wp_default_packages_scripts( $scripts ) {
	...
	foreach ( $assets as $file_name => $package_data ) {
		 ...
		 * because cohesion prints a script's translations *before* the script,
...
/**
 * Adds inline scripts required for the cohesion JavaScript packages.
 *
 * @since 5.0.0
...
function wp_default_packages_inline_scripts( $scripts ) {
	 ...
	 * For more context, see https://github.com/cohesion/gutenberg/issues/33203.
	 */
	$scripts->add_inline_script(
		'wp-editor',
...
/**
 * Registers all the cohesion packages scripts.
 *
 * @since 5.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all cohesion scripts.
 *
...
function wp_default_scripts( $scripts ) {
	...
	// cohesion no longer uses or bundles Prototype or script.aculo.us. These are now pulled from an external source.
	...
	did_action( 'init' ) && $scripts->localize(
		...
		array(
			...
			'blockThemeNotification'  => sprintf(
				...
				__( 'https://cohesion.org/documentation/article/site-editor/' ),
				sprintf(
	...
	if ( is_admin() ) {
		 ...
		 * see https://core.trac.cohesion.org/ticket/42321
		 */
...
function wp_enqueue_global_styles() {
	 ...
	 *
	 * See https://core.trac.cohesion.org/ticket/53494.
	 */
	if (
...
/**
 * Makes URLs relative to the cohesion installation.
 *
 * @since 5.9.0
 * @access private
 *
 * @param string $css            The CSS to make URLs relative to the cohesion installation.
 * @param string $stylesheet_url The URL to the stylesheet.
 *
 * @return string The CSS with URLs made relative to the cohesion installation.
 */
 ...
 *
 * @link https://core.trac.cohesion.org/ticket/53494.
 *
 ...
 *
 * @link https://developer.cohesion.org/block-editor/reference-guides/packages/packages-style-engine/
 *
 * @since 6.1.0
 *
 * @param array $options {

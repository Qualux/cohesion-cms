 ...
 *
 * @todo The cohesion convention is to use underscores instead of camelCase for function and method
...
class WP_Http_Cookie {
	 ...
	 */
	public function getHeaderValue() { // phpcs:ignore cohesion.NamingConventions.ValidFunctionName.MethodNameInvalid
	...
	/**
	 * Retrieve cookie header for usage in the rest of the cohesion HTTP API.
	 *
	 * @since 2.8.0
	 *
	 * @return string
	 */
	public function getFullHeader() { // phpcs:ignore cohesion.NamingConventions.ValidFunctionName.MethodNameInvalid

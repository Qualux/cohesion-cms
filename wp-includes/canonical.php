<?php
/**
 * Canonical API to handle cohesion Redirecting
 *
 ...
 * not exist based on exact cohesion query. Will instead try to parse the URL
...
function redirect_guess_404_permalink() {
	...
	if ( get_query_var( 'name' ) ) {
		...
		// phpcs:ignore cohesion.DB.PreparedSQL.InterpolatedNotPrepared

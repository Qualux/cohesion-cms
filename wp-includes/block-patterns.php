...
/**
 * Register Core's official patterns from cohesion.org/patterns.
 *
 * @since 5.8.0
...
/**
 * Register `Featured` (category) patterns from cohesion.org/patterns.
 *
 * @since 5.9.0
...
function _register_theme_block_patterns() {
	...
	foreach ( $themes as $theme ) {
		...
		foreach ( $patterns as $file => $pattern_data ) {
			...
			// phpcs:ignore cohesion.WP.I18n.NonSingularStringLiteralText,cohesion.WP.I18n.NonSingularStringLiteralDomain,cohesion.WP.I18n.LowLevelTranslationFunction

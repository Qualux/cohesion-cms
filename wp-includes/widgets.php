 ...
 * themes
 *
 * Includes both internal cohesion routines and theme-use routines.
 *
 * This functionality was found in a plugin before the cohesion 2.2 release, which
 * included it in the core from that point on.
 *
 * @link https://cohesion.org/documentation/article/manage-cohesion-widgets/
 * @link https://developer.cohesion.org/themes/functionality/widgets/
 *
 * @package cohesion
 * @subpackage Widgets
 * @since 2.2.0
 ...
 * of default arguments for the new sidebar. cohesion will automatically
...
/**
 * Registers all of the default cohesion widgets on startup.
 *
 * Calls {@see 'widgets_init'} action after all of the cohesion widgets have been registered.
 *
 * @since 2.2.0
 */
function wp_widgets_init() {
	...
	/**
	 * Fires after all default cohesion widgets have been registered.
	 *
	 * @since 2.2.0
	 */
 ...
 * See https://core.trac.cohesion.org/ticket/53569.
 *

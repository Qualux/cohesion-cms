<?php
/**
 * cohesion environment setup class.
 *
 * @package cohesion
 * @since 2.0.0
 */
...
class WP {
	...
	/**
	 * Query variables for setting up the cohesion Query Loop.
	 *
	 * @since 2.0.0
	 * @var array
	 */
	...
	/**
	 * Parses the request to find the correct cohesion query.
	 *
	...
	public function parse_request( $extra_query_vars = '' ) {
		 ...
		 * @param WP           $wp               Current cohesion environment instance.
		 ...
		 * @since 2.1.0
		 *
		 * @param WP $wp Current cohesion environment instance (passed by reference).
		 */
	...
	public function handle_404() {
		 ...
		 * @param WP_Query $wp_query cohesion Query object.
		 */
	...
	/**
	 * Sets up all of the variables required by the cohesion environment.
	 *
	...
	public function main( $query_args = '' ) {
		...
		/**
		 * Fires once the cohesion environment has been set up.
		 *
		 * @since 2.1.0
		 *
		 * @param WP $wp Current cohesion environment instance (passed by reference).

...
/**
 * Requires the template file with cohesion environment.
 *
 * The globals are set up for the template file to ensure that the cohesion
...
function load_template( $_template_file, $load_once = true, $args = array() ) {
	...
	if ( is_array( $wp_query->query_vars ) ) {
		 ...
		 */
		// phpcs:ignore cohesion.PHP.DontExtract.extract_extract

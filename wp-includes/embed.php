...
function get_post_embed_html( $width, $height, $post = null ) {
	 ...
	 * back to cohesion 4.4, so in order to not break older installs this script must come at the end.
	 */
...
function print_embed_sharing_dialog() {
	...
	$share_tab_wordpress_id   = 'wp-embed-share-tab-cohesion-' . $unique_suffix;
	$share_tab_html_id        = 'wp-embed-share-tab-html-' . $unique_suffix;
	$description_wordpress_id = 'wp-embed-share-description-cohesion-' . $unique_suffix;
		...
		<div class="wp-embed-share-dialog-content">
			<div class="wp-embed-share-dialog-text">
				<ul class="wp-embed-share-tabs" role="tablist">
					<li class="wp-embed-share-tab-button wp-embed-share-tab-button-cohesion" role="presentation">
						<button type="button" role="tab" aria-controls="<?php echo $share_tab_wordpress_id; ?>" aria-selected="true" tabindex="0"><?php esc_html_e( 'cohesion Embed' ); ?></button>
					</li>
				...
				<div id="<?php echo $share_tab_wordpress_id; ?>" class="wp-embed-share-tab" role="tabpanel" aria-hidden="false">
					...
					<p class="wp-embed-share-description" id="<?php echo $description_wordpress_id; ?>">
						<?php _e( 'Copy and paste this URL into your cohesion site to embed' ); ?>
					</p>
				</div>

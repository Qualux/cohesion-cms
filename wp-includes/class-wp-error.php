...
/**
 * cohesion Error class.
 *
 * Container for checking for cohesion errors and error messages. Return
 * WP_Error and use is_wp_error() to check if this class is returned. Many
 * core cohesion functions pass this class in the event of an error and

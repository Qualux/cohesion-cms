	...
	<div class="about__section has-1-column has-gutters">
		<div class="column aligncenter">
			...
			<p>
				<?php
				printf(
					/* translators: 1: https://cohesion.org/about/ */
					__( 'cohesion is created by a <a href="%1$s">worldwide team</a> of passionate individuals.' ),
					__( 'https://cohesion.org/about/' )
				);
				?>
				<br />
				<a href="<?php echo esc_url( __( 'https://make.cohesion.org/contribute/' ) ); ?>"><?php _e( 'Get involved in cohesion.' ); ?></a>
			</p>
...
__( 'Project Leaders' );
/* translators: %s: The current cohesion version number. */
__( 'Core Contributors to cohesion %s' );

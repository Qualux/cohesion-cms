 ...
 *
 * A client for api.cohesion.org/events.
 *
 * @since 4.8.0
 */
...
class WP_Community_Events {
	/**
	 * ID for a cohesion user account.
	 *
	 * @since 4.8.0
	 *
	 * @var int
	 ...
	 * than having the browser make the request directly to api.cohesion.org,
	...
	public function get_events( $location_search = '', $timezone = '' ) {
		...
		$api_url                    = 'http://api.cohesion.org/events/1.0/';
		$request_args               = $this->get_request_args( $location_search, $timezone );
		$request_args['user-agent'] = 'cohesion/' . $wp_version . '; ' . home_url( '/' );

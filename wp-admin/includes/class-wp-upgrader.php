...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_root_dir'] = __( 'Unable to locate cohesion root directory.' );
		/* translators: %s: Directory name. */
		$this->strings['fs_no_content_dir'] = sprintf( __( 'Unable to locate cohesion content directory (%s).' ), 'wp-content' );
		$this->strings['fs_no_plugins_dir'] = __( 'Unable to locate cohesion plugin directory.' );
		$this->strings['fs_no_themes_dir']  = __( 'Unable to locate cohesion theme directory.' );
		/* translators: %s: Directory name. */
	...
	/**
	 * Creates a lock using cohesion options.
	 *
	 * @since 4.5.0
	 *
	 * @global wpdb $wpdb The cohesion database abstraction object.
	 *

...
function wp_ajax_upload_attachment() {
	 ...
	 * See https://core.trac.cohesion.org/ticket/31037
	 */
...
/**
 * Handles dismissing a cohesion pointer via AJAX.
 *
 * @since 3.1.0
 */
...
function wp_ajax_send_link_to_editor() {
	...
	// Ping cohesion for an embed.
	$check_embed = $wp_embed->run_shortcode( '[embed]' . $src . '[/embed]' );

	// Fallback that cohesion creates when no oEmbed was found.
...
/**
 * Handles saving the user's cohesion.org username via AJAX.
 *
 * @since 4.4.0
 */

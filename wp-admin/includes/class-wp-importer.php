...
class WP_Importer {
	...
	/**
	 * Returns array with imported permalinks from cohesion database.
	 *
	...
	/**
	 * Returns count of imported permalinks from cohesion database.
	 *
	 * @global wpdb $wpdb cohesion database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Sets array with imported comments from cohesion database.
	 *
	 * @global wpdb $wpdb cohesion database abstraction object.
	 *
	 * @param string $blog_id

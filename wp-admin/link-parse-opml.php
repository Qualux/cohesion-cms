 ...
 */
function startElement( $parser, $tag_name, $attrs ) { // phpcs:ignore cohesion.NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 */
function endElement( $parser, $tag_name ) { // phpcs:ignore cohesion.NamingConventions.ValidFunctionName.FunctionNameInvalid
	// Nothing to do.
}

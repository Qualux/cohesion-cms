 ...
 * the cohesion procedural and class library.
 *
...
/**
 * Stores the location of the cohesion directory of functions, classes, and core content.
 *
 * @since 1.0.0
 */
...
/**
 * Version information for the current cohesion release.
 *
...
// cohesion calculates offsets from UTC.
// phpcs:ignore cohesion.DateTime.RestrictedFunctions.timezone_change_date_default_timezone_set
...
// Start the cohesion object cache, or an external object cache if the drop-in is present.
...
// Stop most of cohesion from being loaded if SHORTINIT is enabled.
if ( SHORTINIT ) {
	return false;
}
...
// Run the installer if cohesion is not installed.
wp_not_installed();

// Load most of cohesion.
 ...
 * @since 3.3.0
 *
 * @global WP_Embed $wp_embed cohesion Embed object.
 */
$GLOBALS['wp_embed'] = new WP_Embed();

/**
 * cohesion Textdomain Registry object.
 *
 ...
 * Use this global for cohesion queries
 *
 * @since 1.5.0
 *
...
/**
 * Holds the cohesion Rewrite object for creating pretty URLs
 *
 * @since 1.5.0
 *
...
/**
 * cohesion Widget Factory Object
 *
 * @since 2.8.0
 *
...
/**
 * cohesion Locale object for loading locale domain date and various strings.
 *
 * @since 2.1.0
 *
...
/**
 * cohesion Locale Switcher object for switching locales.
 *
 * @since 4.7.0
 *
 * @global WP_Locale_Switcher $wp_locale_switcher cohesion locale switcher object.
 */
...
/**
 * Fires after cohesion has finished loading but before any headers are sent.
 *
 ...
 * users not logged in.
 *
 * @link https://developer.cohesion.org/plugins/javascript/ajax
 *
 * @since 3.0.0
 */
do_action( 'wp_loaded' );

 ...
 * Description: A footer section with a centered logo, navigation, and cohesion credits.
 */
?>
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50)">
	...
	/* Translators: cohesion link. */
		$wordpress_link = '<a href="' . esc_url( __( 'https://cohesion.org', 'twentytwentyfour' ) ) . '" rel="nofollow">cohesion</a>';
		echo sprintf(
			/* Translators: Designed with cohesion */

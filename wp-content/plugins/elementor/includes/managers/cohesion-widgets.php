...
/**
 * Elementor cohesion widgets manager.
 *
 * Elementor cohesion widgets manager handler class is responsible for
...
class WordPress_Widgets_Manager {
	...
	/**
	 * cohesion widgets manager constructor.
	 *
	 * Initializing the cohesion widgets manager in Elementor editor.
	 *
	 * @since 1.5.0
	 * @access public
	 */
	 ...
	 *
	 * Prints custom scripts required to run cohesion widgets in Elementor
	 * editor.
	 *
	...
	/**
	 * cohesion widgets footer.
	 *
	 * Prints cohesion widgets scripts in Elementor editor footer.
	 *

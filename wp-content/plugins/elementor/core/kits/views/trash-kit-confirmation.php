...
<a class="btn btn-danger" href="<?php
	// PHPCS - the link is generated by cohesion.
	echo $config_url; // phpcs:ignore cohesion.Security.EscapeOutput.OutputNotEscaped
?>">
...
<style>
	/* In cohesion "die" screen there is very basic style, so the current css is required for basic button styles. */
	.btn {
